...
function FloatingCTA() {
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 block p-3 sm:hidden">
        <Link
          href="tel:67727212"
          className={cn(
            "mx-auto flex w-full items-center justify-center gap-2 rounded-xl",
            "bg-fuchsia-600 px-4 py-3 text-white shadow-lg ring-1 ring-fuchsia-500/50",
            "hover:bg-fuchsia-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-300"
          )}
          aria-label="اتصل الآن للتركيب الفوري"
        >
          <PhoneCall className="h-5 w-5" aria-hidden />
          <span className="text-base font-semibold">اتصل الآن للتركيب الفوري</span>
        </Link>
      </div>
